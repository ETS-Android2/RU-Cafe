...
public class Coffee extends MenuItem implements Customizable {
    ...
    static double SMALL_PRICE = 1.99;
    static final double TALL_PRICE = SMALL_PRICE + 0.50;
    static final double GRANDE_PRICE = TALL_PRICE + 0.50;
    static final double VENTI_PRICE = GRANDE_PRICE + 0.50;
    final double PER_EXTRA = 0.20;
